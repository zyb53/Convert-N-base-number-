...
/// <returns></returns>
static int baseN_encode(char *datas, int dataslen ,int srcBase ,int dstBase ,char *out_buff ,int out_buffsz)
{
...
{
	//char Imei[200] = "868474043802386";
	char Imei[200] = "234543456765678767876789";
	static char buff[200];
	int res = baseN_encode(Imei ,strlen(Imei) ,10 ,62 ,buff ,sizeof(buff));
	printf("%s\r\n",buff );
